...
__webpack_require__(/*! @/scss/index.scss */ 17);

__webpack_require__(/*! @/utils/registerBaseStyle.js */ 18);

__webpack_require__(/*! @/utils/filters.js */ 19);

var _globalJump = _interopRequireDefault(__webpack_require__(/*! @/utils/globalJump */ 20));
...
_vue.default.prototype.$jump = _globalJump.default;

_vue.default.prototype.$toast = function (title, cb) {
...
var _default = {
  ...
  methods: _objectSpread(_objectSpread({}, (0, _vuex.mapMutations)(["setStatusHeight", "setSystemInfo"])), {}, {
    // 获取并设置状态栏高度
